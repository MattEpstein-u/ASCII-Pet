@echo off
REM Installation script for ASCII Desktop Pet on Windows

echo === ASCII Desktop Pet Installation for Windows ===
echo.
...
echo Shortcut.Description = "ASCII Desktop Pet - Cute ASCII art desktop companion" >> create_shortcut.vbs
